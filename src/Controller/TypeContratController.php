...
class TypeContratController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success', 'Le nouveau type de contrat a bien été créé!');
            return $this->redirectToRoute('type_contrat_new');
        }
    ...
    /**
     * @Route("/{id}/del", name="contrat_delete")
     */
    public function del(TypeContratRepository $typeContratRepository , $id): Response
    {
        $contrat = $typeContratRepository->find($id);
        $entityManager = $this->getDoctrine()->getManager();
